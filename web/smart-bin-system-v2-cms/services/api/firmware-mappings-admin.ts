...
export const firmwareMappingsAdminApi = {
  getMappings: async (params?: { page?: number; size?: number }) => api.get<PagedPayload<FirmwareMappingDto>>("/firmware-mappings", params, { cacheTTL: 300000 }),
  createMapping: async (request: CreateFirmwareMappingRequest) => api.post<FirmwareMappingDto>("/firmware-mappings", request),
  getMappingById: async (id: string) => api.get<FirmwareMappingDto>(`/firmware-mappings/${id}`, undefined, { cacheTTL: 300000 }),
