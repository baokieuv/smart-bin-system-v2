...
export default function TenantsPage() {
  ...
  return (
    <div className="space-y-4">
      <Panel title="Tenants" subtitle="Manage tenant accounts for super admin">
        <form className="grid gap-4 md:grid-cols-[1fr_1fr_auto]" onSubmit={createTenant}>
          <div>
          ...
          <button
            type="submit"
            className="self-end rounded-xl bg-[linear-gradient(120deg,#0b3b62,#176ea5)] px-4 py-2.5 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(22,99,156,0.35)] transition hover:brightness-110"
          >
            Create tenant
          </button>
        </form>
